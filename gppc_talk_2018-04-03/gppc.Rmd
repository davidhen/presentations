...
\item mortality
\end{itemize}
\item<3-> Assess how measures of multimorbidity and health \& social care service use can be operationalised by linking existing health \& social care administrative data
\end{itemize}
...
\item Count of prescibing from BNF chapters
...
data <- tribble( ~start_date, ~event, ~displ,
                ...
                ymd(20160201), "Initial meeting with Renfrewshire", -0.7,
                ymd(20160524), "Ethical Approval", 0.5,
                ymd(20160712), "RAC approval", -0.5,
                ymd(20170208), "Ethical approval",-0.5,
                ymd(20170210), "RAC approval", 0.3,
                ymd(20170906), "DSA signed", 0.3,
                ymd(20170921), "Data transferred", -0.5,
                ymd(20180227), "Analysis complete", 0.5,
                ymd(20161118), "RAC submission", 0.6,
                ymd(20170404), "PBPP submission", -0.3,
                ymd(20170505), "PBPP approval", 0.2,
                ymd(20160429), "RAC submission", 0.7,
                ymd(20171122), "Health data available", 0.7,
                ymd(20171213), "DSA signed", -0.3,
                ymd(20180221), "SCS available", -0.2)
...
timeline <- timeline + 
  annotate("text", x = ymd(20151001), y =  1, label = "Pilot Project", colour = "red") +
  annotate("text", x = ymd(20151001), y = 0.9,   label = "Main Project", colour = "blue")
