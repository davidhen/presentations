...
\begin{itemize}
\item<1-> There is a strong socioeconomic gradient observed for those with multimorbidity
\item<1-> This feeds the inverse care law in primary care services 
\end{itemize}

MM associated with...
\begin{itemize}
\item<2-> Higher mortality
\item<2-> Psychological distress
\item<2-> Worse QOL
\item<2-> Worse functional status
\item<2-> Increased health care use...
\end{itemize}
